...
**Seven** source types are in use (row counts as of 2026-09-21, cross-checked by
`scripts/kb-structure-check.sh` § 5, which flags any drift from `SOURCES.md`):

| Type | What it is | Rows |
|---|---|---|
| `github` | One repo — commits and releases since the last run | 41 |
| `rss` | RSS/Atom feed | 14 |
| `x` | An X.com profile timeline | 10 |
