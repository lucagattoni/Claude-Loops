...
| 25 | [Long-Running Agents](https://lucagattoni.github.io/Claude-Loops/25-long-running-agents/) | Ralph loop (origin: ghuntley.com), planner-worker-judge, Inner/Outer Dual Loop, git-based recovery; session watchdog + 2h hard limit; multi-day Harness-of-Harness case study (70+ iterations); codex-maxxing megathread persistence |
