...
// "1.1 The Paradigm Shift" and its sections become "1.1.1 …", "1.1.2 …".
//
...
document$.subscribe(function () {
  ...
  // The current page's nav link text starts with its number, e.g. "1.1 The Paradigm Shift".
  ...
  // Skip section numbering on the meta "Project" pages (8.x: news / sources /
  // changelog) — their headings are machine-generated and shouldn't be renumbered.
  if (pageNum.split(".")[0] === "8") return;
